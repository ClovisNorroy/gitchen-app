import { Box, Button, Container, Paper, Stack, Typography, Card, Grid, CardContent} from "@mui/material";
...
export default function Home() {
  ...
  const features = [
    {
      ...
      description: "Planifiez vos repas pour toute la semaine sans effort, assurant une alimentation équilibrée et organisée."
    },
    {
      icon: <ShoppingCart fontSize="large" color="primary" />, 
      title: "Liste de Courses", 
      description: "Générez automatiquement une liste de courses basée sur votre planning de repas."
    },
    {
      icon: <RestaurantMenu fontSize="large" color="primary" />, 
      title: "Gestion des Recettes", 
      description: "Sauvegardez et organisez vos recettes préférées, facilitant leur accès et leur utilisation quand vous en avez besoin."
    }
  ];
  ...
  return (
    <Box sx={{ marginTop: 4, width: "100%" }}>
      ...
      <Typography variant="h4" sx={{ mb: 4, fontWeight: "bold", color: "#2c7a7b" }}>
        Fonctions Clés
      </Typography>
      <Grid container spacing={4} justifyContent="center">
        {features.map((feature, index) => (
          <Grid item xs={12} sm={6} md={4} key={index}>
            <Card sx={{ p: 3, boxShadow: 3, borderRadius: 2, textAlign: "center", height: '13em'}}>
              <CardContent>
                {feature.icon}
